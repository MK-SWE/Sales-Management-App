...
interface DecimalQuantityInputProps extends Omit<InputHTMLAttributes<HTMLInputElement>, 'type'> {
  label?: string;
  error?: string;
}

export function DecimalQuantityInput({ label, error, className = '', ...props }: DecimalQuantityInputProps) {
  return (
