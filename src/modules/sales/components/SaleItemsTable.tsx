...
export function SaleItemsTable({ items, onUpdateItem, onRemoveItem }: SaleItemsTableProps) {
  return (
      ...
      <table className="w-full border-collapse">
        <thead>
          <tr className="border-b border-slate-100 bg-slate-50/50">
            ...
            <th className="px-4 py-3 text-left text-xs font-bold text-slate-500 uppercase tracking-wider w-40">Price</th>
