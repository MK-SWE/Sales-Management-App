...
export const SaleFindManySelectSchema: z.ZodType<Prisma.SaleSelect> = z.object({
...
export const SaleFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    saleNumber: z.boolean().optional(),
    warehouseId: z.boolean().optional(),
    clientId: z.boolean().optional(),
...
export const SaleFindManySchema: z.ZodType<Prisma.SaleFindManyArgs> = z.object({ select: SaleFindManySelectSchema.optional(), include: z.lazy(() => SaleIncludeObjectSchema.optional()), orderBy: z.union([SaleOrderByWithRelationInputObjectSchema, SaleOrderByWithRelationInputObjectSchema.array()]).optional(), where: SaleWhereInputObjectSchema.optional(), cursor: SaleWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SaleScalarFieldEnumSchema, SaleScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.SaleFindManyArgs>;

export const SaleFindManyZodSchema = z.object({ select: SaleFindManySelectSchema.optional(), include: z.lazy(() => SaleIncludeObjectSchema.optional()), orderBy: z.union([SaleOrderByWithRelationInputObjectSchema, SaleOrderByWithRelationInputObjectSchema.array()]).optional(), where: SaleWhereInputObjectSchema.optional(), cursor: SaleWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SaleScalarFieldEnumSchema, SaleScalarFieldEnumSchema.array()]).optional() }).strict();