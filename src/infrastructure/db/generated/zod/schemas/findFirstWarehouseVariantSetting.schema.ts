...
export const WarehouseVariantSettingFindFirstSelectSchema: z.ZodType<Prisma.WarehouseVariantSettingSelect> = z.object({
...
export const WarehouseVariantSettingFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    warehouseId: z.boolean().optional(),
    variantId: z.boolean().optional(),
    reorderStock: z.boolean().optional(),
...
export const WarehouseVariantSettingFindFirstSchema: z.ZodType<Prisma.WarehouseVariantSettingFindFirstArgs> = z.object({ select: WarehouseVariantSettingFindFirstSelectSchema.optional(), include: z.lazy(() => WarehouseVariantSettingIncludeObjectSchema.optional()), orderBy: z.union([WarehouseVariantSettingOrderByWithRelationInputObjectSchema, WarehouseVariantSettingOrderByWithRelationInputObjectSchema.array()]).optional(), where: WarehouseVariantSettingWhereInputObjectSchema.optional(), cursor: WarehouseVariantSettingWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WarehouseVariantSettingScalarFieldEnumSchema, WarehouseVariantSettingScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.WarehouseVariantSettingFindFirstArgs>;

export const WarehouseVariantSettingFindFirstZodSchema = z.object({ select: WarehouseVariantSettingFindFirstSelectSchema.optional(), include: z.lazy(() => WarehouseVariantSettingIncludeObjectSchema.optional()), orderBy: z.union([WarehouseVariantSettingOrderByWithRelationInputObjectSchema, WarehouseVariantSettingOrderByWithRelationInputObjectSchema.array()]).optional(), where: WarehouseVariantSettingWhereInputObjectSchema.optional(), cursor: WarehouseVariantSettingWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WarehouseVariantSettingScalarFieldEnumSchema, WarehouseVariantSettingScalarFieldEnumSchema.array()]).optional() }).strict();