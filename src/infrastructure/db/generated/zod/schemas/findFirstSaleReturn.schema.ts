...
export const SaleReturnFindFirstSelectSchema: z.ZodType<Prisma.SaleReturnSelect> = z.object({
...
export const SaleReturnFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    returnNumber: z.boolean().optional(),
    originalSaleId: z.boolean().optional(),
    warehouseId: z.boolean().optional(),
...
export const SaleReturnFindFirstSchema: z.ZodType<Prisma.SaleReturnFindFirstArgs> = z.object({ select: SaleReturnFindFirstSelectSchema.optional(), include: z.lazy(() => SaleReturnIncludeObjectSchema.optional()), orderBy: z.union([SaleReturnOrderByWithRelationInputObjectSchema, SaleReturnOrderByWithRelationInputObjectSchema.array()]).optional(), where: SaleReturnWhereInputObjectSchema.optional(), cursor: SaleReturnWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SaleReturnScalarFieldEnumSchema, SaleReturnScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.SaleReturnFindFirstArgs>;

export const SaleReturnFindFirstZodSchema = z.object({ select: SaleReturnFindFirstSelectSchema.optional(), include: z.lazy(() => SaleReturnIncludeObjectSchema.optional()), orderBy: z.union([SaleReturnOrderByWithRelationInputObjectSchema, SaleReturnOrderByWithRelationInputObjectSchema.array()]).optional(), where: SaleReturnWhereInputObjectSchema.optional(), cursor: SaleReturnWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SaleReturnScalarFieldEnumSchema, SaleReturnScalarFieldEnumSchema.array()]).optional() }).strict();