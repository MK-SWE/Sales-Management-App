...
export const InventoryTransferFindFirstOrThrowSelectSchema: z.ZodType<Prisma.InventoryTransferSelect> = z.object({
...
export const InventoryTransferFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    transferNumber: z.boolean().optional(),
    sourceWarehouseId: z.boolean().optional(),
    destWarehouseId: z.boolean().optional(),
