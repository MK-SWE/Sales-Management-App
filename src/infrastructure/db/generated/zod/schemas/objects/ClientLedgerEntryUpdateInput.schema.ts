...
import { ClientUpdateOneRequiredWithoutLedgerEntriesNestedInputObjectSchema as ClientUpdateOneRequiredWithoutLedgerEntriesNestedInputObjectSchema } from './ClientUpdateOneRequiredWithoutLedgerEntriesNestedInput.schema';
import { UserUpdateOneWithoutClientLedgerEntriesNestedInputObjectSchema as UserUpdateOneWithoutClientLedgerEntriesNestedInputObjectSchema } from './UserUpdateOneWithoutClientLedgerEntriesNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  client: z.lazy(() => ClientUpdateOneRequiredWithoutLedgerEntriesNestedInputObjectSchema).optional(),
  createdByUser: z.lazy(() => UserUpdateOneWithoutClientLedgerEntriesNestedInputObjectSchema).optional()
}).strict();
export const ClientLedgerEntryUpdateInputObjectSchema: z.ZodType<Prisma.ClientLedgerEntryUpdateInput> = makeSchema() as unknown as z.ZodType<Prisma.ClientLedgerEntryUpdateInput>;
export const ClientLedgerEntryUpdateInputObjectZodSchema = makeSchema();
