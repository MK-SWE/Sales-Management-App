...
export const UserCountOutputTypeCountSaleReturnsArgsObjectSchema = makeSchema();
export const UserCountOutputTypeCountSaleReturnsArgsObjectZodSchema = makeSchema();
