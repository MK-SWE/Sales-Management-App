...
import { SaleScalarRelationFilterObjectSchema as SaleScalarRelationFilterObjectSchema } from './SaleScalarRelationFilter.schema';
...
const saleitemwhereinputSchema = z.object({
  AND: z.union([z.lazy(() => SaleItemWhereInputObjectSchema), z.lazy(() => SaleItemWhereInputObjectSchema).array()]).optional(),
  OR: z.lazy(() => SaleItemWhereInputObjectSchema).array().optional(),
  NOT: z.union([z.lazy(() => SaleItemWhereInputObjectSchema), z.lazy(() => SaleItemWhereInputObjectSchema).array()]).optional(),
  ...
  sale: z.union([z.lazy(() => SaleScalarRelationFilterObjectSchema), z.lazy(() => SaleWhereInputObjectSchema)]).optional(),
...
export const SaleItemWhereInputObjectSchema: z.ZodType<Prisma.SaleItemWhereInput> = saleitemwhereinputSchema as unknown as z.ZodType<Prisma.SaleItemWhereInput>;
export const SaleItemWhereInputObjectZodSchema = saleitemwhereinputSchema;
