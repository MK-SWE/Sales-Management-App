...
export const WarehouseCountOutputTypeCountTransfersOutArgsObjectSchema = makeSchema();
export const WarehouseCountOutputTypeCountTransfersOutArgsObjectZodSchema = makeSchema();
