...
export const WarehouseCountOutputTypeCountVariantSettingsArgsObjectSchema = makeSchema();
export const WarehouseCountOutputTypeCountVariantSettingsArgsObjectZodSchema = makeSchema();
