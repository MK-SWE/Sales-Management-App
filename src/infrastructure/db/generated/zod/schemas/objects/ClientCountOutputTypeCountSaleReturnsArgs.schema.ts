...
export const ClientCountOutputTypeCountSaleReturnsArgsObjectSchema = makeSchema();
export const ClientCountOutputTypeCountSaleReturnsArgsObjectZodSchema = makeSchema();
