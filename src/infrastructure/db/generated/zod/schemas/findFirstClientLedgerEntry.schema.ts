...
export const ClientLedgerEntryFindFirstSelectSchema: z.ZodType<Prisma.ClientLedgerEntrySelect> = z.object({
...
export const ClientLedgerEntryFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    clientId: z.boolean().optional(),
    type: z.boolean().optional(),
    amount: z.boolean().optional(),
...
export const ClientLedgerEntryFindFirstSchema: z.ZodType<Prisma.ClientLedgerEntryFindFirstArgs> = z.object({ select: ClientLedgerEntryFindFirstSelectSchema.optional(), include: z.lazy(() => ClientLedgerEntryIncludeObjectSchema.optional()), orderBy: z.union([ClientLedgerEntryOrderByWithRelationInputObjectSchema, ClientLedgerEntryOrderByWithRelationInputObjectSchema.array()]).optional(), where: ClientLedgerEntryWhereInputObjectSchema.optional(), cursor: ClientLedgerEntryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ClientLedgerEntryScalarFieldEnumSchema, ClientLedgerEntryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ClientLedgerEntryFindFirstArgs>;

export const ClientLedgerEntryFindFirstZodSchema = z.object({ select: ClientLedgerEntryFindFirstSelectSchema.optional(), include: z.lazy(() => ClientLedgerEntryIncludeObjectSchema.optional()), orderBy: z.union([ClientLedgerEntryOrderByWithRelationInputObjectSchema, ClientLedgerEntryOrderByWithRelationInputObjectSchema.array()]).optional(), where: ClientLedgerEntryWhereInputObjectSchema.optional(), cursor: ClientLedgerEntryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ClientLedgerEntryScalarFieldEnumSchema, ClientLedgerEntryScalarFieldEnumSchema.array()]).optional() }).strict();