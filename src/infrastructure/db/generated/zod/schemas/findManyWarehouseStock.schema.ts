...
export const WarehouseStockFindManySelectSchema: z.ZodType<Prisma.WarehouseStockSelect> = z.object({
...
export const WarehouseStockFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    warehouseId: z.boolean().optional(),
    variantId: z.boolean().optional(),
    quantity: z.boolean().optional(),
...
export const WarehouseStockFindManySchema: z.ZodType<Prisma.WarehouseStockFindManyArgs> = z.object({ select: WarehouseStockFindManySelectSchema.optional(), include: z.lazy(() => WarehouseStockIncludeObjectSchema.optional()), orderBy: z.union([WarehouseStockOrderByWithRelationInputObjectSchema, WarehouseStockOrderByWithRelationInputObjectSchema.array()]).optional(), where: WarehouseStockWhereInputObjectSchema.optional(), cursor: WarehouseStockWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WarehouseStockScalarFieldEnumSchema, WarehouseStockScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.WarehouseStockFindManyArgs>;

export const WarehouseStockFindManyZodSchema = z.object({ select: WarehouseStockFindManySelectSchema.optional(), include: z.lazy(() => WarehouseStockIncludeObjectSchema.optional()), orderBy: z.union([WarehouseStockOrderByWithRelationInputObjectSchema, WarehouseStockOrderByWithRelationInputObjectSchema.array()]).optional(), where: WarehouseStockWhereInputObjectSchema.optional(), cursor: WarehouseStockWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WarehouseStockScalarFieldEnumSchema, WarehouseStockScalarFieldEnumSchema.array()]).optional() }).strict();