...
export const QuotationItemFindManySelectSchema: z.ZodType<Prisma.QuotationItemSelect> = z.object({
...
export const QuotationItemFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    quotationId: z.boolean().optional(),
    quotation: z.boolean().optional(),
    ProductVariantId: z.boolean().optional(),
