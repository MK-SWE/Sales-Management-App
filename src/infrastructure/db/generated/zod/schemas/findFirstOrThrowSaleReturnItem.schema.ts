...
export const SaleReturnItemFindFirstOrThrowSelectSchema: z.ZodType<Prisma.SaleReturnItemSelect> = z.object({
...
export const SaleReturnItemFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    saleReturnId: z.boolean().optional(),
    variantId: z.boolean().optional(),
    quantity: z.boolean().optional(),
...
export const SaleReturnItemFindFirstOrThrowSchema: z.ZodType<Prisma.SaleReturnItemFindFirstOrThrowArgs> = z.object({ select: SaleReturnItemFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => SaleReturnItemIncludeObjectSchema.optional()), orderBy: z.union([SaleReturnItemOrderByWithRelationInputObjectSchema, SaleReturnItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: SaleReturnItemWhereInputObjectSchema.optional(), cursor: SaleReturnItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SaleReturnItemScalarFieldEnumSchema, SaleReturnItemScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.SaleReturnItemFindFirstOrThrowArgs>;

export const SaleReturnItemFindFirstOrThrowZodSchema = z.object({ select: SaleReturnItemFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => SaleReturnItemIncludeObjectSchema.optional()), orderBy: z.union([SaleReturnItemOrderByWithRelationInputObjectSchema, SaleReturnItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: SaleReturnItemWhereInputObjectSchema.optional(), cursor: SaleReturnItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SaleReturnItemScalarFieldEnumSchema, SaleReturnItemScalarFieldEnumSchema.array()]).optional() }).strict();