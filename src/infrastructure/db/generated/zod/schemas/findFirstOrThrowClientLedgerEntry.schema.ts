...
export const ClientLedgerEntryFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ClientLedgerEntrySelect> = z.object({
...
export const ClientLedgerEntryFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    clientId: z.boolean().optional(),
    type: z.boolean().optional(),
    amount: z.boolean().optional(),
...
export const ClientLedgerEntryFindFirstOrThrowSchema: z.ZodType<Prisma.ClientLedgerEntryFindFirstOrThrowArgs> = z.object({ select: ClientLedgerEntryFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ClientLedgerEntryIncludeObjectSchema.optional()), orderBy: z.union([ClientLedgerEntryOrderByWithRelationInputObjectSchema, ClientLedgerEntryOrderByWithRelationInputObjectSchema.array()]).optional(), where: ClientLedgerEntryWhereInputObjectSchema.optional(), cursor: ClientLedgerEntryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ClientLedgerEntryScalarFieldEnumSchema, ClientLedgerEntryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ClientLedgerEntryFindFirstOrThrowArgs>;

export const ClientLedgerEntryFindFirstOrThrowZodSchema = z.object({ select: ClientLedgerEntryFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ClientLedgerEntryIncludeObjectSchema.optional()), orderBy: z.union([ClientLedgerEntryOrderByWithRelationInputObjectSchema, ClientLedgerEntryOrderByWithRelationInputObjectSchema.array()]).optional(), where: ClientLedgerEntryWhereInputObjectSchema.optional(), cursor: ClientLedgerEntryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ClientLedgerEntryScalarFieldEnumSchema, ClientLedgerEntryScalarFieldEnumSchema.array()]).optional() }).strict();