...
export const WarehouseFindManySelectSchema: z.ZodType<Prisma.WarehouseSelect> = z.object({
...
export const WarehouseFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    code: z.boolean().optional(),
    name: z.boolean().optional(),
    location: z.boolean().optional(),
