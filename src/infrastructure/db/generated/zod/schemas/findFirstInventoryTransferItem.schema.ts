...
export const InventoryTransferItemFindFirstSelectSchema: z.ZodType<Prisma.InventoryTransferItemSelect> = z.object({
...
export const InventoryTransferItemFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    transferId: z.boolean().optional(),
    variantId: z.boolean().optional(),
    quantity: z.boolean().optional(),
