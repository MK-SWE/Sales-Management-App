...
export const InventoryTransferItemFindFirstOrThrowSelectSchema: z.ZodType<Prisma.InventoryTransferItemSelect> = z.object({
...
export const InventoryTransferItemFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    transferId: z.boolean().optional(),
    variantId: z.boolean().optional(),
    quantity: z.boolean().optional(),
...
export const InventoryTransferItemFindFirstOrThrowSchema: z.ZodType<Prisma.InventoryTransferItemFindFirstOrThrowArgs> = z.object({ select: InventoryTransferItemFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => InventoryTransferItemIncludeObjectSchema.optional()), orderBy: z.union([InventoryTransferItemOrderByWithRelationInputObjectSchema, InventoryTransferItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: InventoryTransferItemWhereInputObjectSchema.optional(), cursor: InventoryTransferItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([InventoryTransferItemScalarFieldEnumSchema, InventoryTransferItemScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.InventoryTransferItemFindFirstOrThrowArgs>;

export const InventoryTransferItemFindFirstOrThrowZodSchema = z.object({ select: InventoryTransferItemFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => InventoryTransferItemIncludeObjectSchema.optional()), orderBy: z.union([InventoryTransferItemOrderByWithRelationInputObjectSchema, InventoryTransferItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: InventoryTransferItemWhereInputObjectSchema.optional(), cursor: InventoryTransferItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([InventoryTransferItemScalarFieldEnumSchema, InventoryTransferItemScalarFieldEnumSchema.array()]).optional() }).strict();