...
export const InventoryTransferFindFirstSelectSchema: z.ZodType<Prisma.InventoryTransferSelect> = z.object({
...
export const InventoryTransferFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    transferNumber: z.boolean().optional(),
    sourceWarehouseId: z.boolean().optional(),
    destWarehouseId: z.boolean().optional(),
...
export const InventoryTransferFindFirstSchema: z.ZodType<Prisma.InventoryTransferFindFirstArgs> = z.object({ select: InventoryTransferFindFirstSelectSchema.optional(), include: z.lazy(() => InventoryTransferIncludeObjectSchema.optional()), orderBy: z.union([InventoryTransferOrderByWithRelationInputObjectSchema, InventoryTransferOrderByWithRelationInputObjectSchema.array()]).optional(), where: InventoryTransferWhereInputObjectSchema.optional(), cursor: InventoryTransferWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([InventoryTransferScalarFieldEnumSchema, InventoryTransferScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.InventoryTransferFindFirstArgs>;

export const InventoryTransferFindFirstZodSchema = z.object({ select: InventoryTransferFindFirstSelectSchema.optional(), include: z.lazy(() => InventoryTransferIncludeObjectSchema.optional()), orderBy: z.union([InventoryTransferOrderByWithRelationInputObjectSchema, InventoryTransferOrderByWithRelationInputObjectSchema.array()]).optional(), where: InventoryTransferWhereInputObjectSchema.optional(), cursor: InventoryTransferWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([InventoryTransferScalarFieldEnumSchema, InventoryTransferScalarFieldEnumSchema.array()]).optional() }).strict();