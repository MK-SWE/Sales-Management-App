...
export const QuotationItemFindFirstOrThrowSelectSchema: z.ZodType<Prisma.QuotationItemSelect> = z.object({
...
export const QuotationItemFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    quotationId: z.boolean().optional(),
    quotation: z.boolean().optional(),
    ProductVariantId: z.boolean().optional(),
