...
export const ClientPaymentFindManySelectSchema: z.ZodType<Prisma.ClientPaymentSelect> = z.object({
...
export const ClientPaymentFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    paymentNumber: z.boolean().optional(),
    clientId: z.boolean().optional(),
    amount: z.boolean().optional(),
...
export const ClientPaymentFindManySchema: z.ZodType<Prisma.ClientPaymentFindManyArgs> = z.object({ select: ClientPaymentFindManySelectSchema.optional(), include: z.lazy(() => ClientPaymentIncludeObjectSchema.optional()), orderBy: z.union([ClientPaymentOrderByWithRelationInputObjectSchema, ClientPaymentOrderByWithRelationInputObjectSchema.array()]).optional(), where: ClientPaymentWhereInputObjectSchema.optional(), cursor: ClientPaymentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ClientPaymentScalarFieldEnumSchema, ClientPaymentScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ClientPaymentFindManyArgs>;

export const ClientPaymentFindManyZodSchema = z.object({ select: ClientPaymentFindManySelectSchema.optional(), include: z.lazy(() => ClientPaymentIncludeObjectSchema.optional()), orderBy: z.union([ClientPaymentOrderByWithRelationInputObjectSchema, ClientPaymentOrderByWithRelationInputObjectSchema.array()]).optional(), where: ClientPaymentWhereInputObjectSchema.optional(), cursor: ClientPaymentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ClientPaymentScalarFieldEnumSchema, ClientPaymentScalarFieldEnumSchema.array()]).optional() }).strict();