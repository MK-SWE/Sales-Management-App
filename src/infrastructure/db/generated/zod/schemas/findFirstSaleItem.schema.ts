...
export const SaleItemFindFirstSelectSchema: z.ZodType<Prisma.SaleItemSelect> = z.object({
...
export const SaleItemFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    saleId: z.boolean().optional(),
    variantId: z.boolean().optional(),
    productNameSnapshot: z.boolean().optional(),
