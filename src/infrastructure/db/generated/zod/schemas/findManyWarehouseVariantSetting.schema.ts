...
export const WarehouseVariantSettingFindManySelectSchema: z.ZodType<Prisma.WarehouseVariantSettingSelect> = z.object({
...
export const WarehouseVariantSettingFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    warehouseId: z.boolean().optional(),
    variantId: z.boolean().optional(),
    reorderStock: z.boolean().optional(),
...
export const WarehouseVariantSettingFindManySchema: z.ZodType<Prisma.WarehouseVariantSettingFindManyArgs> = z.object({ select: WarehouseVariantSettingFindManySelectSchema.optional(), include: z.lazy(() => WarehouseVariantSettingIncludeObjectSchema.optional()), orderBy: z.union([WarehouseVariantSettingOrderByWithRelationInputObjectSchema, WarehouseVariantSettingOrderByWithRelationInputObjectSchema.array()]).optional(), where: WarehouseVariantSettingWhereInputObjectSchema.optional(), cursor: WarehouseVariantSettingWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WarehouseVariantSettingScalarFieldEnumSchema, WarehouseVariantSettingScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.WarehouseVariantSettingFindManyArgs>;

export const WarehouseVariantSettingFindManyZodSchema = z.object({ select: WarehouseVariantSettingFindManySelectSchema.optional(), include: z.lazy(() => WarehouseVariantSettingIncludeObjectSchema.optional()), orderBy: z.union([WarehouseVariantSettingOrderByWithRelationInputObjectSchema, WarehouseVariantSettingOrderByWithRelationInputObjectSchema.array()]).optional(), where: WarehouseVariantSettingWhereInputObjectSchema.optional(), cursor: WarehouseVariantSettingWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WarehouseVariantSettingScalarFieldEnumSchema, WarehouseVariantSettingScalarFieldEnumSchema.array()]).optional() }).strict();