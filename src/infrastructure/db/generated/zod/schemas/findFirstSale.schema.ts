...
export const SaleFindFirstSelectSchema: z.ZodType<Prisma.SaleSelect> = z.object({
...
export const SaleFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    saleNumber: z.boolean().optional(),
    warehouseId: z.boolean().optional(),
    clientId: z.boolean().optional(),
...
export const SaleFindFirstSchema: z.ZodType<Prisma.SaleFindFirstArgs> = z.object({ select: SaleFindFirstSelectSchema.optional(), include: z.lazy(() => SaleIncludeObjectSchema.optional()), orderBy: z.union([SaleOrderByWithRelationInputObjectSchema, SaleOrderByWithRelationInputObjectSchema.array()]).optional(), where: SaleWhereInputObjectSchema.optional(), cursor: SaleWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SaleScalarFieldEnumSchema, SaleScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.SaleFindFirstArgs>;

export const SaleFindFirstZodSchema = z.object({ select: SaleFindFirstSelectSchema.optional(), include: z.lazy(() => SaleIncludeObjectSchema.optional()), orderBy: z.union([SaleOrderByWithRelationInputObjectSchema, SaleOrderByWithRelationInputObjectSchema.array()]).optional(), where: SaleWhereInputObjectSchema.optional(), cursor: SaleWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SaleScalarFieldEnumSchema, SaleScalarFieldEnumSchema.array()]).optional() }).strict();