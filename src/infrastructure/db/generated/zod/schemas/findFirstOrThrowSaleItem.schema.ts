...
export const SaleItemFindFirstOrThrowSelectSchema: z.ZodType<Prisma.SaleItemSelect> = z.object({
...
export const SaleItemFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    saleId: z.boolean().optional(),
    variantId: z.boolean().optional(),
    productNameSnapshot: z.boolean().optional(),
...
export const SaleItemFindFirstOrThrowSchema: z.ZodType<Prisma.SaleItemFindFirstOrThrowArgs> = z.object({ select: SaleItemFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => SaleItemIncludeObjectSchema.optional()), orderBy: z.union([SaleItemOrderByWithRelationInputObjectSchema, SaleItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: SaleItemWhereInputObjectSchema.optional(), cursor: SaleItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SaleItemScalarFieldEnumSchema, SaleItemScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.SaleItemFindFirstOrThrowArgs>;

export const SaleItemFindFirstOrThrowZodSchema = z.object({ select: SaleItemFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => SaleItemIncludeObjectSchema.optional()), orderBy: z.union([SaleItemOrderByWithRelationInputObjectSchema, SaleItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: SaleItemWhereInputObjectSchema.optional(), cursor: SaleItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SaleItemScalarFieldEnumSchema, SaleItemScalarFieldEnumSchema.array()]).optional() }).strict();